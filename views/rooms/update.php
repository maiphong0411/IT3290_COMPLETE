...
<form action="" method="post" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <input type="text" name="city"
               value="<?php echo isset($_POST['city']) ? $_POST['city'] : $product['city'] ?>"
               class="form-control" id="city"/>
    </div>
    <div class="form-group">
        <label for="home_number">home_number</label>
        <input type="number" name="home_number"
               value="<?php echo isset($_POST['home_number']) ? $_POST['home_number'] : $product['home_number'] ?>"
               class="form-control" id="home_number"/>
    </div>
    <div class="form-group">
        <label for="street">street</label>
        <input type="text" name="street"
               value="<?php echo isset($_POST['street']) ? $_POST['street'] : $product['street'] ?>"
               class="form-control" id="street"/>
    </div>
    <div class="form-group">
        <label for="district">district</label>
        <input type="text" name="district"
               value="<?php echo isset($_POST['district']) ? $_POST['district'] : $product['district'] ?>"
               class="form-control" id="district"/>
    </div>
    <div class="form-group">
        <label for="max_people">max_people</label>
        <input type="number" name="max_people"
               value="<?php echo isset($_POST['max_people']) ? $_POST['max_people'] : $product['max_people'] ?>"
    ...
    <div class="form-group">
        ...
        <input type="number" name="time"
               value="<?php echo isset($_POST['time']) ? $_POST['time'] : $product['time'] ?>"
    ...
    <div class="form-group">
      ...
      <textarea class="form-control"
              name="description"><?php echo isset($_POST['description']) ? $_POST['description'] : $product['description']; ?></textarea>
    </div>
    <div class="form-group">
        <label for="state">State</label>
        <input type="number" name="state"
               value="<?php echo isset($_POST['state']) ? $_POST['state'] : $product['state'] ?>"
    ...
    <div class="form-group">
        ...
        <input type="text" name="area" value="<?php echo isset($_POST['area']) ? $_POST['area'] : $product['area'] ?>"
               class="form-control" id="area"/>
    </div>
    <div class="form-group">
        <label for="date_start">date_start</label>
        <input type="date" name="date_start" id="date_start"
               value="<?php echo isset($_POST['date_start']) ? $_POST['date_start'] : $product['date_start'] ?>"
               class="form-control"/>
    </div>
    <div class="form-group">
        <label for="expire">expire</label>
        <input type="date" name="expire" id="expire"
               value="<?php echo isset($_POST['expire']) ? $_POST['expire'] : $product['expire'] ?>"
               class="form-control"/>
    </div>
    <div class="form-group">
