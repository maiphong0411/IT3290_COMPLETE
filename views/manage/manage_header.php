...
if (isset($_SESSION['user'])) {
    ...
    $year = date('Y', strtotime($_SESSION['user']['account_start']));
}
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="assets/images/avatar_admin.png" class="user-image" alt="User Image">
                        <span class="hidden-xs"><?php echo $username; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="assets/images/avatar_admin.png" class="img-circle" alt="User Image">
                            <p>
                                <?php echo $username . ' - ' . $job; ?>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="index.php?controller=manage&action=updatemanager" class="btn btn-default btn-flat">Profile</a>
                            </div>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
                <a href="index.php?controller=manage&action=myuser">
            ...
            <li>
                <a href="index.php?controller=manage&action=render_care">
                    <i class="fa fa-info"></i> <span>Thông báo </span>
                    <span class="pull-right-container">
              <!--<small class="label pull-right bg-green">new</small>-->
            </span>
                </a>
